...
public interface Function2<A, B, C> {
     ...
     */
    default <D> Function2<A, B, D> compose(Function1<C, D> g) {
     ...
     */
    default Function1<B, C> bind1(A arg1) {
     ...
     */
    default Function1<A, C> bind2(B arg2) {
     ...
     * @return function from A to C
     */
    default Function1<A, C> curry(B arg2) {
        return arg1 -> apply(arg1, arg2);
    }
}
